...
<div className="Rates_Items_Content">
  <div className='Content content-1'>
    ...
    <h3 className={`Content_h3 ${theme}`}>Job Success Score on Upwork</h3>
  </div>

  <div className={`star ${theme}`}>
    <img src={theme === "light" ? StarLight.src : StarDark.src} alt="" />
  </div>

  <div className='Content content-2'>
    <h2 className={`Content_h2 ${theme}`}>{">"}25.00</h2>
    <h3 className={`Content_h3 ${theme}`}>Duplicates on Figma Community</h3>
  </div>
